...
public class MemberDTO {
	...
	public MemberDTO(String userNo, String userId, String userPwd, String userName, String userBirth,
			...
			String user_Regst_Date, String user_Leave_Chk) {
		super();
		this.userNo = userNo;
		this.userId = userId;
	...
	public String getUser_Regst_Date() {
		return user_Regst_Date;
	}
	public void setUser_Regst_Date(String user_Regst_Date) {
		this.user_Regst_Date = user_Regst_Date;
	}
