...
<head>
    ...
    <link rel="stylesheet" href="/missingitnow/resources/css/common/header.css">
</head>
...
<body>
    <header>
        <div class="nav">
            ...
            <div class="menu">
                ...
                <div class="sidebar">
                    <div class="information">
                        <div class="profile"><img src="/missingitnow/resources/img/header/profile.png" alt=""></div>
                    ...
                    <div class="test">
                        ...
                        <div class="category">
                            ...
                            <ul>
                                ...
                                <li class="category-title">
                                    <div class="category-title-style"><a href="${ pageContext.servletContext.contextPath }/member/myPageMain">MY PAGE</a></div>
                                </li>
                                <li class="category-title">
            ...
            <!-- 로고 -->
            <div class="logo">
                <img class="logo-png" src="/missingitnow/resources/img/logo.PNG" class="icons_img" alt="" width="80px" >
            </div>
            ...
            <div class="search">
                ...
                <div class="search_bar">
                    ...
                    <a href="#" type="submit"><img src="/missingitnow/resources/img/search.png" class="search_img" alt=""></a>
                </div>
                <!-- </form> -->
            </div>
            ...
            <!-- 아이콘 -->
            <div class="icons">
                <img src="/missingitnow/resources/img/ic.PNG" class="icons_img" alt="">
            </div>
...
<head>
    ...
    <link rel="stylesheet" href="/bogo/resources/css/reset.css">
    <link rel="stylesheet" href="/bogo/resources/css/header.css">
</head>
<script src="https://code.jquery.com/jquery-3.5.1.js"></script>
<script>
    $(document).ready(function () {
...
<body>
    <header>
        <div class="nav">
            ...
            로고
            <div class="logo">
                <img src="/bogo/resources/img/logo.PNG" class="icons_img" alt="">
            </div>
            ...
            <div class="search">
                ...
                <div class="search_bar">
                    <input class="search_size" type="text" title="검색">
                    <a href="#" type="submit"><img src="/bogo/resources/img/search.png" class="search_img" alt="" ></a>
                </div>
                </form>
            </div>
            ...
            아이콘
            <div class="icons">
                <img src="/bogo/resources/img/ic.PNG" class="icons_img" alt="">
            </div>
